...
class Registration {
    ...
    static removeInviteFromDb(req, res) {
        ...
        return new Promise(
            (resolve, reject) => {
                User.findOne({ email: req.body.friendEmail }, function (err, res) {
                    console.log(req.body);
                    if (err) {
                        reject(err);
                    } else {
                        console.log("removeInviteFromDb - ARE YOU WORKING?");
                        if (res) {
                            console.log("removeInviteFromDb - FIRST RESOLVE");
                            console.log(res);
                            Invite.findOneAndRemove({ friendEmail: res.email }, function (err, docs) {
                                resolve(res);
                            });
                        } else {
                            console.log("removeInviteFromDb - SECOND RESOLVE");
                            console.log(res);
                            resolve();
                        }
                    }
...
module.exports = Registration;
        ...
        // return new Promise(
        //     (resolve, reject) => {
        //         Invite.findOneAndRemove({ friendEmail: email}), function (err, invite) {
        //             console.log(invite);
